...
<div id="content">
  <div id="menu">
    ...
    <form action="codeJournaux.MyController" method="POST">
      <div class="form-content">
        <div class="champ-label">Code</div>
        <div class="champ-case"><input id="numCompte" type="text" name="code" placeholder="code" required></div>
    ...
    <form action="importXLSCJ.Importateur" method="POST" enctype="multipart/form-data">
      <div class="form-content">
    ...
    <a href="codeJournaux.Pagination?page=1&afficher=10"><h4>Affichage code journaux</h4></a>
  </div>
</div>
